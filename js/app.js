(() => {
  ...
  document.documentElement.clientWidth,
    document.querySelector(".repair-body-header__text");
  const he = document.querySelector(".sub-menu-header__block"),
    me = document.querySelector(".sub-menu-header-close"),
    fe = document.querySelector(".repair-body-header__button"),
    ge = document.querySelector(".repair-body-header__repair-mobile");
  fe.addEventListener("click", function (e) {
    he.classList.contains("sub-menu-header__block-active")
      ? (he.classList.remove("sub-menu-header__block-active"),
        this.classList.remove("repair-body-header__button-rotated"),
        ge.classList.remove("repair-mobile-sub-menu-active"))
      : (he.classList.toggle("sub-menu-header__block-active"),
        this.classList.toggle("repair-body-header__button-rotated"),
        ge.classList.toggle("repair-mobile-sub-menu-active"));
  }),
    me.addEventListener("click", function (e) {
      he.classList.remove("sub-menu-header__block-active"),
        ge.classList.remove("repair-mobile-sub-menu-active");
    });
  const ve = document.getElementById("device"),
    be = document.querySelector(".list-device");
  ve.addEventListener("focus", () => {
    be.classList.toggle("list-device-active"),
      we.classList.toggle("icon-device-active");
  }),
    document.addEventListener("click", function (e) {
      const t = e.target;
      t != ve &&
        t != ye &&
        (be.classList.remove("list-device-active"),
        we.classList.remove("icon-device-active")),
        t != Se &&
          t != Ce &&
          (Te.classList.remove("list-mark-active"),
          Ee.classList.remove("icon-mark-active")),
        t != xe &&
          t != ke &&
          (Le.classList.remove("list-model-active"),
          Me.classList.remove("icon-model-active")),
        t != Oe &&
          (Pe.classList.remove("body-header__phones-active"),
          Pe.hasAttribute("phone-appear") &&
            Pe.removeAttribute("phone-appear"));
    });
  const ye = document.querySelector("#devicebtn");
  ye.addEventListener("click", function (e) {
    be.classList.toggle("list-device-active"),
      we.classList.toggle("icon-device-active");
  });
  const we = document.querySelector(".icon-device");
  document.querySelectorAll(".item-device").forEach((e) => {
    const t = e.innerHTML;
    e.addEventListener("click", () => (ve.value = t));
  });
  const Se = document.getElementById("mark"),
    Te = document.querySelector(".list-mark");
  Se.addEventListener("focus", () => {
    Te.classList.toggle("list-mark-active"),
      Ee.classList.toggle("icon-mark-active");
  });
  const Ce = document.querySelector("#markbtn");
  Ce.addEventListener("click", function (e) {
    Te.classList.toggle("list-mark-active"),
      Ee.classList.toggle("icon-mark-active");
  });
  const Ee = document.querySelector(".icon-mark");
  document.querySelectorAll(".item-mark").forEach((e) => {
    const t = e.innerHTML;
    e.addEventListener("click", () => (Se.value = t));
  });
  const xe = document.getElementById("model"),
    Le = document.querySelector(".list-model");
  xe.addEventListener("focus", () => {
    Le.classList.toggle("list-model-active"),
      Me.classList.toggle("icon-model-active");
  });
  const ke = document.querySelector("#modelbtn");
  ke.addEventListener("click", function (e) {
    Le.classList.toggle("list-model-active"),
      Me.classList.toggle("icon-model-active");
  });
  const Me = document.querySelector(".icon-model");
  document.querySelectorAll(".item-model").forEach((e) => {
    const t = e.innerHTML;
    e.addEventListener("click", () => (xe.value = t));
  });
  const Ae = document.querySelector(".phones-body-header-mobile"),
    Oe = document.querySelector(".phones-body-header-mobile__button"),
    Pe = document.querySelector(".phones-body-header");
  Oe.addEventListener("click", function (e) {
    Pe.classList.toggle("body-header__phones-active");
  });
  const $e = document.querySelector(".find-device__button");
  document.getElementById("findFooter").addEventListener("click", function (e) {
    _e.classList.toggle("find-device-open");
  });
  ...
  document
    .querySelector(".seacrh-header__close")
    .addEventListener("click", function (e) {
      _e.classList.remove("find-device-open");
    });
  const Ie = document.documentElement.clientWidth,
    ze = document.querySelector(".header__body"),
    qe = document.querySelector(".body-header__container");
  window.onload = () => {
    if (Ie > 730) {
      const e = new IntersectionObserver(
        (e, t) => {
          e.forEach((e) => {
            e.isIntersecting
              ? (ze.classList.remove("body-header--container-fixed"),
                Ae.classList.remove("phones-body-header-mobile-sticky"),
                qe.classList.remove("body-header__container-fixed"))
              : (ze.classList.toggle("body-header--container-fixed"),
                Ae.classList.toggle("phones-body-header-mobile-sticky"),
                qe.classList.toggle("body-header__container-fixed"));
          });
        },
  ...
  const Be = document.querySelector(".button-discount"),
    De = document.querySelector(".content-discount"),
    Ge = document.querySelector(".content-discount__hidden-button");
  Be.addEventListener("click", function (e) {
    De.hasAttribute("hidden") &&
      (De.removeAttribute("hidden"), Be.classList.toggle("button-hidden"));
  }),
    Ge.addEventListener("click", function (e) {
      De.setAttribute("hidden", 0), Be.classList.remove("button-hidden");
    });
  const He = document.querySelector(".button-news"),
    Ne = document.querySelector(".content-news"),
    Fe = document.querySelector(".content-news__hidden-button");
  He.addEventListener("click", function (e) {
    Ne.hasAttribute("hidden") &&
      (Ne.removeAttribute("hidden"), He.classList.toggle("button-hidden"));
  }),
    Fe.addEventListener("click", function (e) {
      Ne.setAttribute("hidden", 0), He.classList.remove("button-hidden");
    });
  document
    .querySelector(".button-return")
    .addEventListener("click", function (e) {
      window.scrollTo(0, -15e3);
    }),
    (window.FLS = !0),
    (function (e) {
      let t = new Image();
    ...
    (function () {
      ...
      function o(e, t) {
        ...
        if ("items" === (e.dataset.showmore ? e.dataset.showmore : "size")) {
          ...
          s = t.dataset.showmoreContent ? t.dataset.showmoreContent : 0;
        }
        return s;
      }
      function d(e) {
        ...
        } else "resize" === d && (t.length && a(t), n.length && r(n));
      }
      e.length &&
